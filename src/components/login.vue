  ...
  <div class="flex items-center w-full justify-between" v-if="isAuthenticated">
    <div class="flex items-center">
      <img
        ...
        :src="userPicture"
        alt="Avatar"
        class="rounded-full w-16 h-16 mr-3 object-cover"
        width="64"
        height="64"
      />
    ...
    <Button @click="onClickSignOut" variant="secondary" :disabled="loading"
      ><Loader2 class="w-4 h-4 mr-2 animate-spin" v-if="loading" />注销</Button
    >
  </div>
